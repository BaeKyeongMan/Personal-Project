...
void ClearScreen()
{
    ...
    // 콘솔 창의 가로 x 세로 크기를 구해야 전체를 채울 수 있습니다.
    ...
    // 커서 위치도 다시 (0, 0)으로 되돌려주는 게 국룰입니다.
...
// 2. 플레이어가 몬스터와 좌표가 겹친 상태로 몬스터에 맞는 버튼을 누르면
// 3. 몬스터가 사라지고 다른 랜덤한 좌표에서 재생성
// 4. n초 안에 n번 성공하면 클리어

// 코드적 기능
// 1. SetConsoleCursorInfo를 사용해서 커서를 숨기고 SetConsoleCursorPosition를 사용해서 게임설명
